    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(RegisterActivity.this,"All Filelds Are Requird",Toast.LENGTH_SHORT).show();
                }
                else if (text_password.length()<6)
                {
                    Toast.makeText(RegisterActivity.this,"password Must be at list 6 charters",Toast.LENGTH_SHORT).show();
...
//function to register in firebase
    private void Register(final String username, String eamil, String password)
    {
        auth.createUserWithEmailAndPassword(eamil,password)
